using UnityEngine;
public class PlayerCharacterUnet : Character
{
    ...
    private MouseLookUnet mouseLook;
    private Vector3 currentVelocity;
    protected override FireActionUnet fireAction { get; set; }
    protected override void Initiate()
    {
        base.Initiate();
        fireAction = gameObject.AddComponent<RayShooterUnet>();
        fireAction.Reloading();
        characterController = GetComponentInChildren<CharacterController>();
        characterController ??= gameObject.AddComponent<CharacterController>();
        mouseLook = GetComponentInChildren<MouseLookUnet>();
        mouseLook ??= gameObject.AddComponent<MouseLookUnet>();
    }
